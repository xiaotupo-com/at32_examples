...
static void lcd_set_input_mode(uint8_t cursor_dir, uint8_t display_shift);
static void lcd_set_cursor_mode(uint8_t show, uint8_t blink);

/* 创建 lcd1602 实例 */
struct lcd1602_t lcd = {
    .init = lcd1602_init,
    .clear = lcd_clear,
    .set_cursor = lcd_set_cursor,
    .print = lcd_print,
    .set_input_mode = lcd_set_input_mode,
    .set_cursor_mode = lcd_set_cursor_mode,
	.current_edit = 0
};
