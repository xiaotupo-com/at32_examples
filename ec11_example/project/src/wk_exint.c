...
void wk_exint_config(void)
{
  ...
  gpio_init_struct.gpio_pins = EC11_A_EXINT6_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(EC11_A_EXINT6_GPIO_PORT, &gpio_init_struct);

  scfg_exint_line_config(SCFG_PORT_SOURCE_GPIOG, SCFG_PINS_SOURCE6);
